const translations = {
    tw: {
        ...
        p1_explain: "使用者可以在這裡註冊與登入帳號，開始他們的學習旅程。",
        ...
        p3_explain: "這是開發者／平台擁有者收錢（獲利）的地方。學生可以使用當地的信用卡、電子錢包或轉帳付款。",
        ...
        p4_explain: "學生在這裡觀看高品質且加密防盜的教學影片，並可以隨時向 AI 助教發問取得即時解答。",
    ...
    en: {
        ...
        p1_explain: "Users can register and log in to their accounts here to start their learning journey.",
        ...
        p2_explain: "Students from different countries (Taiwan, Indonesia, Vietnam) can learn without barriers using interfaces and subtitles in their native languages.",
        ...
        p3_explain: "This is where the developer/platform owner receives money (monetization). Students can pay using local credit cards, e-wallets, or bank transfers.",
        ...
        p4_explain: "Students watch high-quality, copy-protected instructional videos here and can ask the AI assistant questions at any time for instant answers.",
    ...
    id: {
        ...
        p1_explain: "Pengguna dapat mendaftar dan masuk ke akun mereka di sini untuk memulai perjalanan belajar.",
        ...
        p2_explain: "Siswa dari berbagai negara (Taiwan, Indonesia, Vietnam) dapat belajar tanpa hambatan menggunakan antarmuka dan subtitle dalam bahasa asli mereka.",
        ...
        p3_explain: "Di sinilah pengembang/pemilik platform menerima uang (monetisasi). Siswa dapat membayar menggunakan kartu kredit lokal, dompet digital, atau transfer bank.",
    ...
    vn: {
        ...
        p1_explain: "Người dùng có thể đăng ký và đăng nhập tài khoản tại đây để bắt đầu hành trình học tập.",
        ...
        p2_explain: "Học viên từ các quốc gia khác nhau (Đài Loan, Indonesia, Việt Nam) có thể học tập không rào cản bằng giao diện và phụ đề bằng ngôn ngữ mẹ đẻ.",
        ...
        p3_explain: "Đây là nơi nhà phát triển/chủ sở hữu nền tảng nhận tiền (kiếm tiền). Học viên có thể thanh toán bằng thẻ tín dụng nội địa, ví điện tử hoặc chuyển khoản ngân hàng.",
        ...
        p4_explain: "Học viên xem các video giảng dạy chất lượng cao, được mã hóa chống sao chép tại đây và có thể đặt câu hỏi cho trợ lý AI bất kỳ lúc nào để nhận câu trả lời ngay lập tức.",
